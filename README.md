...
---
### 5. 기대 효과
보건복지부에서는 독거노인 복지서비스 ‘노인맞춤돌봄서비스’를 제공
안전 확인, 사회참여지원, 생활교육지원, 일상생활지원 등 세분화된 서비스가 제공되고 있지만, 현장에서 이 서비스를 제공해주는 전담사회복지사, 생활지원사의 수는 독거노인 수에 비해 부족함
이런 인력부족 속에서 ‘누구에게, 어떤 강도로, 어떤 서비스를 매칭해주는지’에 대한 정밀한 기준이 부족하기에 정부도 대상자 선정도구(신체/정신/사회참여 영역의 취약요인을 조사하여 대상자 선정여부, 서비스 제공시간의 범위 등을 산정)를 활용하여 총점을 계산하고 우선순위를 선정하지만, 이러한 제도는 특정 영역에서 심각한 어려움을 느끼는 대상자를 누락시켜버리는 한계점을 보임
또한, 운둔형/우울형 노인에 대한 ‘특화 서비스 별도 실시’도 제공된다고 하지만, 운둔형과 우울형 노인 발굴에도 많은 시간과 노력이 소요됨
...
- [Cluster 3 : 생활습관/흡연위협형] 금연 및 건강 검진 등 보건/건강교육 및 치료 프로그램 제공


 **랜덤포레스 중요도를 통한 명확한 대상자 색출**
