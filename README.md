...
알고리즘 분석 결과, 전체 3,448명의 독거노인은 뚜렷한 특징을 가진 5개의 페르소나로 분류.
...
**클러스터링을 통한 인적 자원 분배**
클러스터링 결과 최저위험군이 전체의 약 54%를 차지하고, 최고위험군은 전체의 2.1%를 차지하고 있다. 클러스터링을 활용하면 부족한 인적자원을 효율적으로 활용할 수 있음
