...
- **데이터 출처:** 보건복지부
- **수록 항목:** 전국 17개 시도 × 3개년(2022~2024) 데이터, 5개 연령대(65~69, 70~74, 75~79, 80~84, 85세 이상) 인구 분포 (총 51개 행)
...
- **데이터 규모:** 전국 요양기관 **104,775개소 (Instances)** (2025년 12월 기준)
...
또한, 운둔형/우울형 노인에 대한 ‘특화 서비스 별도 실시’도 제공된다고 하지만, 은둔형과 우울형 노인 발굴에도 많은 시간과 노력이 소요됨
